...
that went through a tree of `SceneOb` instances and rendered the contents of the individual `SceneOb`s. We already needed to build in some
functionality into `RenderSceneOb()` 
